    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        if (adding) {
            ...
            for (ChromaHUDParser parser : parsers) {
                ...
                client.textRenderer.draw(text, (current.getScaledWidth() - client.textRenderer.getStringWidth(text)) >> 1, cursorY, Color.RED.getRGB(), true);
                cursorY += 30;
                ...
                for (Map.Entry<String, String> entry : names.entrySet()) {
                    ...
                    if (displayElement == null) {
                        ...
                        client.textRenderer.draw(text2, (current.getScaledWidth() - client.textRenderer.getStringWidth(text2)) >> 1, cursorY, Color.RED.getRGB(),
                            true);
                        cursorY += 15;
                        continue;
                    }
                    ...
                    int stringWidth = client.textRenderer.getStringWidth(text1);
